...
class SSLearnerLeaf(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, y, tree_id=0,level=0, feature_subset = None):
        ...
        is_semisupervised = train_labels[ train_labels[train_labels.columns[0]] == -1 ].shape[0] >= 1
        complete_labels = []
        if is_semisupervised:
            ...
            for label in self.columns:
                ...
                sup_model = RandomForestClassifier(n_estimators = 10 , n_jobs=1 , class_weight='balanced')
                ...
                # sup_model= KNeighborsClassifier(n_neighbors=1)
